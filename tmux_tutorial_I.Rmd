...
In the figure above, the lower pane shows the dates and times when the different sessions were created and on the lower right corner on the green status bar, the time at which the screenshot was taken is shown.
...
----------------------------------------------------------------------------------------------------------------------------
### What appears below is additional information

**Rename current session from within Tmux**

$ tmux rename-session [new_name]

**List out the named sessions
